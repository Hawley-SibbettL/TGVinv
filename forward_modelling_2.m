function varargout = forward_modelling_2(varargin)
% FORWARD_MODELLING_2 M-file for forward_modelling_2.fig
%      FORWARD_MODELLING_2, by itself, creates a new FORWARD_MODELLING_2 or raises the existing
%      singleton*.
%
%      H = FORWARD_MODELLING_2 returns the handle to a new FORWARD_MODELLING_2 or the handle to
%      the existing singleton*.
%
%      FORWARD_MODELLING_2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FORWARD_MODELLING_2.M with the given input arguments.
%
%      FORWARD_MODELLING_2('Property','Value',...) creates a new FORWARD_MODELLING_2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before forward_modelling_2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to forward_modelling_2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help forward_modelling_2

% Last Modified by GUIDE v2.5 22-Feb-2016 10:49:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @forward_modelling_2_OpeningFcn, ...
                   'gui_OutputFcn',  @forward_modelling_2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before forward_modelling_2 is made visible.
function forward_modelling_2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to forward_modelling_2 (see VARARGIN)

% Choose default command line output for forward_modelling_2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes forward_modelling_2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = forward_modelling_2_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in save_mesh_button.
function save_mesh_button_Callback(hObject, eventdata, handles)
% hObject    handle to save_mesh_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global mesh input
...
% --- Executes on button press in load_model_button.
function load_model_button_Callback(hObject, eventdata, handles)
% hObject    handle to load_model_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global mesh input
load('fwd_model')
...
cla
imagesc(reshape(mesh.init_res_param,len_xdim,len_ydim)'); colorbar; colormap cool;
ax = gca;
...
% --- Executes during object creation, after setting all properties.
function save_mesh_button_CreateFcn(hObject, eventdata, handles)
% hObject    handle to save_mesh_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
